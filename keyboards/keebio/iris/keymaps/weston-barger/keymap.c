...
#define _VIM 1
#define _NORMAL 2
#define _NORMAL_ONE 3
#define _NORMAL_TWO 4
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_DEFAULT] = LAYOUT(
     ...
     KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_ESC,          _______,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                                    KC_LGUI, MO(_NORMAL), KC_ENT,                    KC_SPC,  MO(_SPECIAL), KC_RALT
  ),
  ...
  [_NORMAL] = LAYOUT(
     ...
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                            XXXXXXX, XXXXXXX, TO(_DEFAULT), XXXXXXX, XXXXXXX, XXXXXXX,
 ...
 *  - a layer that holds all of the special keys like parenth etc
 *
 *  will be nice for maintaince if we can use fall throughs on actual vim mode
 *
 */
