...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NORMAL] = LAYOUT(
     ...
     _______, XXXXXXX, XXXXXXX, XXXXXXX, TG(_VISUAL), BOW, XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
...
layer_state_t layer_state_set_user(layer_state_t state) {
    uprintf("state: %d\n", state);
    uprintf("statecmp: %d\n", layer_state_cmp(state, _DEFAULT));
    uprintf("statecmp: %d\n", layer_state_cmp(state, _VIM));
    uprintf("statecmp: %d\n", layer_state_cmp(state, _NORMAL));
