...
class Keymap:
    ...
    DEFAULTS = {
        'navigate_up': [Screen.KEY_UP, ord('k')],
        'navigate_down': [Screen.KEY_DOWN, ord('j')],
        'select': [ord('\n'), ord('\r')],
        ...
        'add_item': [Screen.ctrl('n')],
        'delete_item': [Screen.ctrl('d'), Screen.KEY_DELETE],
        'move_up': [Screen.ctrl('k'), Screen.ctrl(Screen.KEY_UP)],
        'move_down': [Screen.ctrl('j'), Screen.ctrl(Screen.KEY_DOWN)],
    }
