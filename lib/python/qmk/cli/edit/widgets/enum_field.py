...
"""
# TODO(unassigned): Write integration tests for UI rendering and interaction once TUI testing infrastructure is available
...
class EnumField(FieldWidget):
    ...
    def as_asciimatics_widget(self):
        ...
        self._widget = DropdownList(options, label=self.label + ':', name=self._path_string, on_change=self._on_change)
